...
When you have created your model and successfully created a data bundle to be used for training, you are ready to request training. Training can be requested in the Cradl web UI.
