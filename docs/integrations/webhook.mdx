...
To quickly test your connection, go to [Webhook.site](https://webhook.site) and paste your unique auto-generated endpoint into your Webhook URI. Upload a document in Cradl AI, validate it, and then inspect the JSON payload directly on Webhook.site.
