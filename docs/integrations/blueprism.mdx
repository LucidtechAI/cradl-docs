...
**Extracting a regular key-value field**

If the data you want to extract is a regular key-value field, like `total_amount`, do the following:
...
All in all, extracting regular key-value fields and line items fields will look something like
...
[here](https://github.com/LucidtechAI/cradl-integrations/tree/main/BluePrism/demo_process). Remember to first install
