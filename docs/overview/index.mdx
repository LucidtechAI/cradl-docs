...
## Getting started
Ready to get started with Cradl? [Sign up](https://app.cradl.ai/login?redirect=signup&utm_campaign=docs) for a free 
...
<div style={{display: 'flex', width: '75%'}}>
  <Terminal
    lines={[
      ...
      {
        'text': JSON.stringify({
          documentId: 'las:document:123',
          contentType: 'application/pdf'
        }, null, 2),
        'cmd': false
      },
      {
        'text': 'las predictions create las:document:123 las:organization:cradl/las:model:invoice',
        'cmd': true
      },
      {
        'text': JSON.stringify({
...
<BoxContainer>
  <LinkBox title="Blue Prism" width="450px" icon={<Icons.Box size={"48px"} />} url="/integrations/blueprism" text="
    One of the pioneers in the RPA space.
  " />
  <LinkBox title="UiPath" width="450px" icon={<Icons.Box size={"48px"} />} url="/integrations/uipath" text="
    The RPA platform with the by far the largest customer base.
  " />
  <LinkBox title="Zapier" width="450px" icon={<Icons.Box size={"48px"} />} url="/integrations/rest-api" text="
    Automate your workflows across 6.000+ available apps with ease.
  " />
  " />
  <LinkBox title="REST API" width="450px" icon={<Icons.Box size={"48px"} />} url="/integrations/rest-api" text="
