...
<BoxContainer>
  <TextBox title="Build your model" width="450px" text={[
    "1. Create high-accuracy and low-latency document parsing deep learning models",
    "2. Train and deploy your deep learning models to your solution using a simple REST API",
    "3. Re-train, iterate and improve your deployed deep learning models seamlessly"
  ]} />
  <img src="/img/input_output.png" alt="Icon" height="270px" />
</BoxContainer>

### Use your models with our CLI, SDKs or REST API

<BoxContainer>
  <div style={{display: 'flex', width: '30%', padding: '0px 0px'}}>
  <img src="/img/invoice.png" alt="Icon" height="100%" />
  </div>
