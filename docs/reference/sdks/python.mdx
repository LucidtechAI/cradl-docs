...
- See full reference <a href="/static/python-docs/index.html" target="_blank">here</a>.
...
client = Client()
```
If you are new to LAS we recommend you to check out the [key concepts](../../concepts/models.mdx)
