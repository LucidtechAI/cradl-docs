...
- Removed status 'training' in /models. This status have been superseeded by endpoint /models/:id/trainings. All /models with status 'training' has had their status to 'active' or 'inactive'
...
- Added PATCH /models/:id/trainings
