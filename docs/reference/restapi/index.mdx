...
- Removed status 'training' in /models. This status have been superseeded by endpoint /models/:id/trainings. /models with status 'training' have had their status to 'active' or 'inactive'
