...
Once your model is defined, you can create one or more [Data bundles](training-data.mdx) to specify which data it should be trained on. You must create a data bundle of acceptable quality before training is allowed. Read more about data quality [here](training-data.md#data-quality).
