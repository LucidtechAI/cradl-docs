...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Nested structure representing line items / tables
      </td>
      <td>
        <p><code>␣0123456789</code>
        </p>
...
When you have created your model and successfully created a data bundle to be used for training, you are ready to request training. Training can be [requested in the Cradl UI](../get-started/train-model.mdx).
