...
After the training is requested you will receive an email that verifies the request, and when the training is completed.
You can also check the request of your training, by looking at its status.
