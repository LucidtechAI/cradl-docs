...
Since the quality of the trained model depends on the quality of the data,
we will make a [Data Report](training-data.mdx#data-report) that needs to be approved by one of our Data Scientists before the training can begin.
