...
| TE003 | Too unevenly distributed enum values. One or more of the enum values have considerable fewer examples than the others. Consider restructuring the enum categories. |
