...
A Lines field is used for column layouts. You only need **_one_** Lines field for an entire table of columns.
...
A common mistake when creating a Lines field is to create a Lines field that corresponds to a singular line on your document. One Lines field can contain a whole table of items &lpar;which will save you _a lot_ of time&rpar;.

    <Tabs>

<TabItem value="example-1" label="Correct" default>
  <div class="image-backdrop utils-mb-10 utils-admonition-success-background">
    <div class="image-backdrop-caption">
      A correctly created Lines field &lpar;of the above table&rpar;. 1 Lines
      field for 1 table.
    </div>
...
<TabItem value="example-2" label="Incorrect" default>
  <div class="image-backdrop utils-mb-10 utils-admonition-danger-background">
    <div class="image-backdrop-caption">
      An incorrectly created Lines field &lpar;of the above table&rpar;. 1 Lines
      fields for 1 specific line in a table.
    </div>
...
You do not need to annotate every line in a Lines field. It is sufficient to annotate a **_minimum of 3 lines_** if your Lines field is several lines long.

So, if a table on your document has 20 lines, you can annotate 3 of the lines instead of all 20. In such a case, it is recommended to annotate 3 **_random_** lines rather than the first 3 lines in the table, for best results.
