...
<div class="image-backdrop-caption text-sm"></div>
  ![A screenshot with instructions](../../static/img/how-to/train-model/1.png)
</div>
...
<Tabs>
 ...
 <TabItem value="mediocre-summary" label="Mediocre summary" default>
...
Do not be discouraged if your initial training scores are mediocre. Crald AI's models improve whenever you correct its mistakes and then run a retraining (we will cover this in the *How to validate documents* section).
