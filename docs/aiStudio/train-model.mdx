...
## Annotation tips
  ...
  **String**
  <p>In addition to regular text and text+numbers, strings can be used for multi-line text fields, such as addresses: </p>
  <div>
...
<div class="utils-spacerBottom-md"></div>
  ...
  **Date**
  <p>Dates are very common to extract. When you type a date in a date field, you should **mirror** the way the date is written on your document. I.e, don't format the date - type the date exactly as it is written on the document </p>
  :::info
