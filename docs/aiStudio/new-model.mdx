...
<h3><span style={{display: "block", marginBottom: "1rem"}}>Welcome to Cradl AI! </span> In this guide, you will train an AI model to automatically extract data from your image or PDF documents into JSON, ready for export to your other apps. </h3>
...
![A screenshot with instructions](../../static/img/how-to/create-model/models.png)
</div>
...
<div class="image-backdrop-caption">The 4 parts of a Flow:</p>
...
<div class="image-backdrop">
<div class="image-backdrop-caption text-sm"></div>
![A screenshot with instructions](../../static/img/how-to/create-model/model-overview.png)
</div>
...
<div class="image-backdrop">
<div class="image-backdrop-caption text-sm"></div>
![A screenshot with instructions](../../static/img/how-to/create-model/model-modal.png)
</div>


**Model from template vs. model from scratch**
<p>Whether to start from scratch or whether to start from a template depends on what you want to extract from your documents.</p>
...
<div>
<div class="image-backdrop">
<div class="image-backdrop-caption text-sm">Typical data you would want to extract from an invoice include: the recipent's full name, the recipient's address, invoice ID number, total amount, VAT, currency, etc.</div>
...
![A screenshot with instructions](../../static/img/how-to/create-model/fields.png)
</div>
...
{/* <details>
  ...
  <p>A common usecase for strings are addresses, which you can create in one string field instead of making multiple fields for each line of the address:</p>
  <div>
    ![A screenshot with instructions](../../static/img/annotate/annotate-string-address.png)
    </div>
</details> */}
{/* 
<details>
...
{/* <details>
  ...
  <div>
  ![A screenshot with instructions](../../static/img/create-model/create-model-lineItems.png)
  </div>
</details> */}
