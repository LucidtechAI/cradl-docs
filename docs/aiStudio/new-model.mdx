...
<ScrollProgressBar />
This guide is intended to walk you through the essential steps in Cradl AI. Once you have completed the guide, you will:

- have an AI model that is trained to scan your documents.
- have a workflow where you automatically import documents (images and PDFs), scan them into structured data with your AI model, and be set to export the data to your preferred destination.

:::info
For those who prefer a visual learning experience, we have a detailed video tutorial that covers the same content. 
<iframe width="560" height="315" src="https://www.youtube.com/embed/E_zXAPF2K9A?si=v8DoNlI3idRm-Viw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
:::

## 1. New Flow
### Go to Flows
Start by completing the sign-up to a [free Cradl AI account](https://app.cradl.ai/login). Once logged in: 
...
<p class="image-backdrop-caption text-sm">Welcome to your Flow builder. A Flow is simply a pipeline that connects an AI model with your documents' Triggers and Export destinations.</p>
![Image](../../static/img/flow/flow-overview.png)
</div>

<div class="utils-mt-22 image-backdrop">
<p class="image-backdrop-caption">The 4 parts of a Flow:</p>
...
Whether to start from scratch or whether to start from a template depends on what you want to extract from your documents. Let's say you want to extract a total amount, a supplier name, an invoice ID, among other things. If you browse through the templates, you will find many templates that have those fields. In that case, you should start with a template instead of from scratch.
...
<div class="utils-mt-22 image-backdrop">
<p class="image-backdrop-caption">The different field data types:</p>
