...
Check out the [**data quality section**](../concepts/training-data.mdx#data-quality) for detailed information about data quality and how to improve it.
...
1. **[Models](https://app.cradl.ai/models) > YourModel > Training jobs > New training**.

![Screenshot of training tab page](/img/train-a-model/training-tab-page.png)

2. Select data bundles to train on, and press **Start training**.

![Screenshot of training dataset selection page](/img/train-a-model/dataset-selection.png)

3. Verify that your training request was successful by inspecting the table in **[Models](https://app.cradl.ai/models) > YourModel > Training jobs**.
