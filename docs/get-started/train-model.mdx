...
To tell the model which data to use, we select datasets containing our training data and attach them to the model in the form of a [ata bundle](../concepts/training-data.mdx). Doing so will automatically create a [data quality report](../concepts/training-data.mdx#data-report) on the training data.
...
```json
{
  "dataBundleId": "las:model-data-bundle:<dataBundleId>",
...
Once you're satisfied with your training data, you can make a request to train your model.
