...
more, then you probably don't need to do anything here. Proceed to the last step where you will get a statistical 
overview of your submitted data. If you are satisfied with the statistical overview, click on the "Start training" button. Your training 
