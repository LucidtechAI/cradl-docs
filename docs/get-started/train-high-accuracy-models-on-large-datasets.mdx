...
instructions [here](../reference/authentication#credentialscfg) to put `credentials.cfg` in the correct folder on your 
system and follow the instructions [here](../reference/cli) to install the CLI.
