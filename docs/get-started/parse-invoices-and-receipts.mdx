...
This is a short demonstration of how you can parse an invoice or receipt in Cradl. Please choose which method you would
...
To begin you'll need to [log in to Cradl](https://app.cradl.ai/login?redirect=login&utm_campaign=docs) and create an 
