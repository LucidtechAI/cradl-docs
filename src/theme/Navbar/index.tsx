...
import TwitterIcon from '@site/static/img/twitter-icon.svg';
    ...
    <nav
      ...
      <div className="navbar__inner">
        ...
        <div className="navbar__items navbar__items--right">
          <a href="https://twitter.com/Cradl_AI" className={styles.customLink} target="_blank">
            <TwitterIcon />
          </a>
          <a href="https://github.com/lucidtechAI" className={styles.customLink} target="_blank">
            <GitHubIcon />
          </a>
          {!colorModeToggle.disabled && (
            <Toggle
