...
export const CtaBox = () => (
  <div className="  bg-blue-50  dark:bg-transparent dark:border-gray-700 dark:border-solid dark:border-1 my-10 rounded-lg shadow-md">
    <h3 className='pb-8 pt-4 px-2 lg:px-4 font-semibold'>Get started quickly with data extraction and streamlining   messy document flows.</h3>
    <div className='flex flex-col xl:flex-row min-h-[420px]'>
      <div className='basis-full xl:basis-1/2 p-4 pt-8 pb-8 lg:p-4 flex flex-col justify-between mb-4'>
        ...
        <video className='shadow-md' width="100%" controls>
            <source src="/video/ai_studio.mp4" type="video/mp4" />
        </video>
      </div>
      <div className='basis-full xl:basis-1/2 p-4 lg:p-4 min-h-[420px] flex flex-col justify-between mb-4'>
        ...
        {/* <div className='flex justify-center items-center '>
          <a href="/aiStudio/new-model" className=' button button--primary button--md h-min text-white' role="button">
            Get started 
          </a>
        </div> */}
    {/* </div>  */}
